...
const Social = () => {
  const handleClick = (e) => {
    ...
    return(<div className="icons" onClick={handleClick}>
      <a class='hoverScale12 tooltip-container' href="https://github.com/TeresaLiang123/Projects" target="_blank">
        <span className='tooltip-text'>My GitHub: TeresaLiang123</span>
        <img src="./github-icon.png" width="50" height="50" className="icon"></img>
      </a>
      <a class='hoverScale12 tooltip-container' href="https://www.linkedin.com/in/liang-teresa/" target="_blank">
